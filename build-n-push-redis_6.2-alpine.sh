...
$DOCKER tag redis-6.2.6-alpine:latest 701240562969.dkr.ecr.us-east-1.amazonaws.com/redis:latest && \
$DOCKER push 701240562969.dkr.ecr.us-east-1.amazonaws.com/redis:latest
